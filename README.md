...
The guidance 1.1 revision answering that finding is released as build `meeting-ingest-0.2.0-g3695fc350c77-s61e1660c5dc8`, installed and pinned. Its acceptance evidence is the 2026-07-29 run — 18/18 blocking, both required reviews concordant — which again used an editable checkout under `--development-override` and is development/non-release evidence. Release-evidence acceptance on the frozen 0.2.0 build has not been run, so milestone-proof semantic acceptance on the approved runtime is not achieved. See `docs/testing/semantic-integrity-acceptance.md`, `docs/sessions/2026-07-26-task7-release-and-acceptance.md`, `docs/sessions/2026-07-29-guidance-1_1-semantic-acceptance-dev-run.md`, and `docs/sessions/2026-07-29-guidance-1_1-release.md`.
